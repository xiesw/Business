package com.halove.business.ui.Dialog;
...
public class CommonDialog extends Dialog {
    ...
    public CommonDialog(Context context, String titleMsg, String contentMsg, String confirmText,
        ...
        this(context, titleMsg, contentMsg, confirmText, null, Utils.dip2px(context, 260),
                confirmListener, null);
    }

    public CommonDialog(Context context, String msg, String contentMsg, String confirmText, int
            dialogWidth, DialogClickListener confirmClick, DialogClickListener cancelClick) {
    ...
    public CommonDialog(Context context, String msg, String contentMsg, String confirmText,
        ...
        this(context, msg, contentMsg, confirmText, cancelText, Utils.dip2px(context, 260),
                confirmClick, null);
    }
    ...
    private void initDialogStyle(String msg, String contentMsg, String confirmText, String
            cancelText, int dialogWidth, final DialogClickListener confirmClick, final
    DialogClickListener cancelClick) {
